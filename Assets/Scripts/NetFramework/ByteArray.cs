...
public class ByteArray
{
    ...
    public void WriteInt(int v) {
        ...
        byte[] byteValue = System.BitConverter.GetBytes(v);
        bw.Write(byteValue);
    }
    /// <summary>
    /// short类型在传输的时候需要从小端转至大端
    /// </summary>
    /// <param name="v"></param>
    public void WriteShort(short v) {
        v = (short)System.Net.IPAddress.HostToNetworkOrder(v);
        byte[] byteValue = System.BitConverter.GetBytes(v);
        bw.Write(byteValue);
    }
    ...
    public void WriteBuffer(LuaByteBuffer strBuffer) {
        WriteInt(strBuffer.buffer.Length);
        write(strBuffer.buffer);
    }
    ...
    /// 神经病注释
    public LuaByteBuffer checkLua(LuaByteBuffer strBuffer)
    {
        int x = 1;
        return strBuffer;
    }
